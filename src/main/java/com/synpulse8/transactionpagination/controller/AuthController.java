...
import com.synpulse8.transactionpagination.model.dto.LoginDTO;
import com.synpulse8.transactionpagination.model.dto.SignupDTO;
import com.synpulse8.transactionpagination.model.dto.TokenDTO;
import com.synpulse8.transactionpagination.repository.RefreshTokenRepository;
...
public class AuthController {
    ...
    public ResponseEntity<?> signup(@Valid @RequestBody SignupDTO dto) {
        User user = new User(dto.getUsername(), dto.getName(), passwordEncoder.encode(dto.getPassword()), dto.getEmail(), dto.getAccountIban());
